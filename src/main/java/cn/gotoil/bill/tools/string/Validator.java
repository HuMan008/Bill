 ...
 *
 * Dolphin cn.gotoil.dolphin.common.tools.string.Validator
 *
 * cluries <cluries@me.com>,  February 2017
 *
 * LastModified: 1/4/17 11:09 AM
 *
 */
...
public class Validator {
    ...
    private static final Pattern isIntPattern = Pattern.compile("^\\d+$");

    public static boolean isInt(String str) {
        return isIntPattern.matcher(str).matches();
    }
